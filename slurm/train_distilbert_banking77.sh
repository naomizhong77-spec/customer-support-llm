#!/bin/bash
#SBATCH --job-name=distilbert_banking77
#SBATCH --partition=MGPU-TC2
#SBATCH --gres=gpu:1
#SBATCH --cpus-per-task=8
#SBATCH --mem=32G
#SBATCH --time=02:00:00             # 5 epochs x ~8.8k samples; expected ~60-90 min; buffer under 6h ceiling
...
python -u scripts/train_distilbert_banking77.py \
